 ...
 * @version 1
 */
public class HelloWorldJOGLAspectColor extends JFrame implements GLEventListener {
	 ...
	 */
	public HelloWorldJOGLAspectColor() {
		this(TITLE);
	}
	 ...
	 */
	public HelloWorldJOGLAspectColor(String title) {
		super(title);
	...
	public static void main(String[] args) {
		HelloWorldJOGLAspectColor frame = new HelloWorldJOGLAspectColor();
